...
| Function                           | Parameters                      | Usage                                                                    |
|------------------------------------|---------------------------------|--------------------------------------------------------------------------|
| Spawn_Special_Weapon(X,Y)          | X = string, Y = player          | Space only                                                               |
| Spawn_From_Reinforcement_Pool(X,Y,Z) | player, position, type (in what order?) |                                                                |
...
| Function                           | Parameters                      | Usage                                                                    |
|------------------------------------|---------------------------------|--------------------------------------------------------------------------|
| Start_Cinematic_Space_Retreat(X,Y) | X = number(playerID), Y = number | -                                                                       |
| End_Cinematic_Mode()               | -                               | -                                                                        |
| Start_Cinematic_Mode()             | -                               | -                                                                        |
| Set_Cinematic_Environment(X)       | X = bool                        | -                                                                        |
| Promote_To_Space_Cinematic_Layer(X) | X = game object                | -                                                                        |
...
| Cinematic_Zoom(X,Y)                | X = number, Y = number          | -                                                                        |
...
| Rotate_Camera_To(?)                | -                               | -                                                                        |
| Rotate_Camera_By(X,Y)              | X = number, Y = number          | -                                                                        |
| Zoom_Camera(X,Y)                   | X = number, Y = number          | -                                                                        |
| Camera_To_Follow(?)                | -                               | -                                                                        |
| Scroll_Camera_To(X)                | X = game object or position(?)  | -                                                                        |
